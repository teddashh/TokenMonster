...
const SAFE_FIXED_MARKERS = new Set([
  ...
  "[TOKENMONSTER_AGENT] STATUS companion_state",
  "[TOKENMONSTER_AGENT] STATUS companion_window",
  "[TOKENMONSTER_AGENT] STATUS companion_initialized",
  "[TOKENMONSTER_AGENT] STATUS companion_shell",
  "[TOKENMONSTER_AGENT] STATUS companion_credentials",
  "[TOKENMONSTER_AGENT] STATUS companion_services",
  "[TOKENMONSTER_AGENT] STATUS companion_bootstrap",
  "[TOKENMONSTER_AGENT] STATUS companion_view",
